...
class summarizer(object):
	...
	#method for splitting text to sentences
	def split_content_to_sentences(self,content):
		content = content.replace("\n",". ")
		return content.split(". ")


		# method to split text to paragraphs
	...
	def sentences_intersection(self,sent1,sent2):
		...
		#split the sentences into tokens/words
		s1 = set(sent1.split(" "))
		s2 = set(sent2.split(" "))
	...
	#converting the content to a dictionary<k,v>
	# k = formatted sentence
	# v = rank/score of the sentence
	def get_sentences_rank(self,content):
		...
		for i in range(0,n):
			for j in range(0,n):
				...
				#zzzzzzzzprint(self.sentences_intersection(sentences[i],sentences[j]))



		# building sentence dictionary
	...
	# return the best sentence in the paragraph
	...
	def get_best_sentence(self,paragraph,sentences_dic):
		...
		max_value = 0
		for s in sentences:
			formatted_sentence = self.format_sentence(s)
			if formatted_sentence:

				if sentences_dic[formatted_sentence]>max_value:
					max_value = sentences_dic[formatted_sentence]
					best_sentence = formatted_sentence
	...
	def get_summary(self,title,content,sentences_dic):
		...
		#add the best sentence from each paragraph to the summary
		for p in paragraphs:
...
def main():
	...
	#create object of summarizer class
	sz = summarizer()


	#build the sentences dictionary
	sentences_dic = sz.get_sentences_rank(content)

	# build the summary with the sentences dictionary
	summary = sz.get_summary(title,content,sentences_dic)
